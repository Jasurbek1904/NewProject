                    ...
                    <div className="col-md-8 col-m-12">
                        <div className="row fanlar">
                            <div className="col-md-4">
                                <h3>Dasturlash</h3>
                                <p><Link to="/error"> Frontend</Link></p>
                                <p><Link to="/error"> Backend</Link></p>
                                <p><Link to="/error"> Foundation</Link></p>
                                <p><Link to="/error"> Ux & Ui design</Link></p>
                                <p><Link to="/error"> Web design</Link></p>
                            </div>
                            <div className="col-md-4">
                                <h3>Ingliz tili</h3>
                                <p><Link to="/error"> English for kids</Link></p>
                                <p><Link to="/error"> General English</Link></p>
                                <p><Link to="/error"> English for IT</Link></p>
                                <p><Link to="/error"> IELTS</Link></p>
                            </div>
                            <div className="col-md-4">
                                <h3>Matematika</h3>
