            ...
            <div className="row mt-5 IconRow">
                <div className="col-md-4">
                    <svg xmlns="http://www.w3.org/2000/svg" width="51" height="51" viewBox="0 0 51 51" fill="none" className="iconsFoun time">
                        ...
                        <path fillRule="evenodd" clipRule="evenodd" d="M50.9168 25.5C50.9168 39.5372 39.5374 50.9166 25.5002 50.9166C11.4629 50.9166 0.0834961 39.5372 0.0834961 25.5C0.0834961 11.4627 11.4629 0.083313 25.5002 0.083313C39.5374 0.083313 50.9168 11.4627 50.9168 25.5ZM45.8335 25.5C45.8335 36.7298 36.73 45.8333 25.5002 45.8333C14.2704 45.8333 5.16683 36.7298 5.16683 25.5C5.16683 14.2702 14.2704 5.16665 25.5002 5.16665C36.73 5.16665 45.8335 14.2702 45.8335 25.5Z" fill="#3F3D56" />
                    </svg>
                    <span>6 oy</span>
                </div>
                <div className="col-md-4">
                    <svg xmlns="http://www.w3.org/2000/svg" width="54" height="54" viewBox="0 0 54 54" fill="none" className="iconsFoun pen">
                        <path fillRule="evenodd" clipRule="evenodd" d="M49.0448 0.82775C48.0523 -0.164833 46.443 -0.164833 45.4504 0.82775L43.2332 3.04498C40.3989 1.69103 36.9014 2.18784 34.5538 4.53541L7.59536 31.4939L21.9732 45.8717L48.9316 18.9133C51.2792 16.5657 51.776 13.0682 50.4221 10.2339L52.6393 8.01667C53.6319 7.02409 53.6319 5.41479 52.6393 4.42221L49.0448 0.82775ZM38.197 22.4589L21.9732 38.6828L14.7843 31.4939L31.0081 15.27L38.197 22.4589ZM42.8185 17.8375L45.3372 15.3188C46.3298 14.3262 46.3298 12.7169 45.3372 11.7243L41.7427 8.12987C40.7501 7.13729 39.1409 7.13729 38.1483 8.12987L35.6296 10.6486L42.8185 17.8375Z" fill="#3F3D56" />
