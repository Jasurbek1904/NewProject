            ...
            {changing ? <>
                <div className='mt-5 container'>
                    <Navbar {...args} expand="lg" className='navbar newNavbar'>
                        <NavbarBrand className="mynavbrand" href='/'>
                            <div className='navbrand' onClick={infinityBgc}>
                                <span>
                        ...
                        <Collapse isOpen={isOpen} navbar className='collapseItem'>
                            <Nav className="me-auto" navbar>
                                <UncontrolledDropdown nav inNavbar>
                                    ...
                                    <DropdownMenu end>
                                        <DropdownItem onClick={changeBgc}><Link to="/dasturlash">Dasturlash</Link></DropdownItem>
                                        <DropdownItem onClick={changeBgc}><Link to="/english">Ingliz tili</Link></DropdownItem>
                                        <DropdownItem onClick={changeBgc}><Link to="/error">Matematika</Link></DropdownItem>
                                    </DropdownMenu>
                                </UncontrolledDropdown>
                                <NavItem onClick={changeBgc}>
                ...
                <div className='mt-5 container'>
                    <Navbar {...args} expand="lg" className='navbar'>
                        <NavbarBrand className="mynavbrand" href='/' onClick={infinityBgc}>
                        ...
                        <Collapse isOpen={isOpen} navbar className='collapseItem'>
                            <Nav className="me-auto" navbar>
                                ...
                                <NavItem>
                                    <NavLink href='/about' onClick={changeBgc}>Biz haqimizda</NavLink>
                                </NavItem>
                                <NavItem>
                                    <NavLink href='/contact' onClick={changeBgc}>Aloqa</NavLink>
                                </NavItem>
                            </Nav>
                            <Link to="/error">
                                <button className='applyBtn' onClick={changeBgc}>Apply</button>
